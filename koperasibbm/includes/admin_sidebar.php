<div class="sidebar">
    <div class="sidebar-brand">
        ...
        <h3>Panel Admin<br><small style="font-size:0.7rem; font-weight:400; opacity:0.8;">Koperasi BBM</small></h3>
        <button type="button" class="panel-menu-toggle" id="panelMenuToggle" aria-label="Buka menu admin">☰</button>
    </div>
    ...
    <ul class="sidebar-menu">
        <li><a href="<?php echo base_url(); ?>/admin/dashboard.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'dashboard.php' ? 'active' : ''; ?>"><i>📊</i> Dasbor</a></li>
        ...
        <li><a href="<?php echo base_url(); ?>/admin/performa.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'performa.php' ? 'active' : ''; ?>"><i>📈</i> Grafik</a></li>
