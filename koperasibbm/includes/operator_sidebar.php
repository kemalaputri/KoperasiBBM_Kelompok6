<div class="sidebar">
    <div class="sidebar-brand">
        ...
        <h3>Operator Panel<br><small style="font-size:0.7rem; font-weight:400; opacity:0.8;">Koperasi BBM</small></h3>
    </div>
    ...
    <ul class="sidebar-menu">
        <li><a href="<?php echo base_url(); ?>/operator/dashboard.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'dashboard.php' ? 'active' : ''; ?>"><i>📊</i> Dashboard</a></li>
        ...
        <li><a href="<?php echo base_url(); ?>/operator/transaksi_offline.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'transaksi_offline.php' ? 'active' : ''; ?>"><i>💰</i> Transaksi Offline</a></li>
