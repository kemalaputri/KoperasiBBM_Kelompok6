        ...
        <div class="content-wrapper">
            <div class="card">
                <form method="GET" style="display:flex; gap:10px; margin-bottom:15px;">
                    <input type="text" name="search" placeholder="Cari nama/username..." value="<?php echo htmlspecialchars($search); ?>" style="flex:1; padding:8px; border:1px solid #ccc; border-radius:5px;">
                ...
                <table>
                    <thead><tr><th>Nama</th><th>Username</th><th>Jenis</th><th>NIS/NIP/Bagian</th><th>Telepon</th></tr></thead>
                    <tbody>
