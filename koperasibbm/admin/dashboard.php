...
<!DOCTYPE html>
<html lang="id">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Dashboard Admin</title>
...
<div class="admin-container">
    ...
    <div class="main-panel">
        <div class="topbar"><h2>Dashboard</h2><span style="color:var(--text-gray); font-size:0.9rem;">Selamat datang, <?php echo htmlspecialchars($_SESSION['nama_lengkap']); ?></span></div>
        <div class="content-wrapper">
            <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap:15px; margin-bottom:25px;">
                ...
                <div class="card" style="margin:0;"><div class="stat-card"><div class="stat-icon" style="background:#8b5cf6;">🛒</div><div class="stat-details"><h4><?php echo $pesanan_online; ?></h4><p>Pesanan Online</p></div></div></div>
                <div class="card" style="margin:0;"><div class="stat-icon" style="background:#64748b;">💰</div><div class="stat-card"><div class="stat-details"><h4><?php echo $trans_offline; ?></h4><p>Pesanan Offline</p></div></div></div>
...
new Chart(ctx, { type: 'bar', data: { labels: ['Online', 'Offline', 'Total'], datasets: [{ label: 'Transaksi (Rp)', data: [<?php echo $total_on; ?>, <?php echo $total_off; ?>, <?php echo $total_all; ?>], backgroundColor: ['#3b82f6', '#10b981', '#f59e0b'], borderRadius: 5 }] }, options: { responsive: true, plugins: { legend: { display: false } } } });
</script>
</body>
</html>