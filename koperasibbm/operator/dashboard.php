...
<!DOCTYPE html>
<html lang="id">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Dasbor Operator</title>
...
<div class="admin-container">
    ...
    <div class="main-panel">
        <div class="topbar"><h2>Dasbor Operator</h2><span style="color:var(--text-gray);">Selamat datang, <?php echo htmlspecialchars($_SESSION['nama_lengkap']); ?></span></div>
        <div class="content-wrapper">
            <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap:15px; margin-bottom:25px;">
                ...
                <div class="card" style="margin:0;"><div class="stat-card"><div class="stat-icon" style="background:#8b5cf6;">💰</div><div class="stat-details"><h4><?php echo $off; ?></h4><p>Penjualan Langsung</p></div></div></div>
                <div class="card" style="margin:0;"><div class="stat-card"><div class="stat-icon" style="background:#0f172a;">📊</div><div class="stat-details"><h4><?php echo $total_trans; ?></h4><p>Total Kegiatan</p></div></div></div>
